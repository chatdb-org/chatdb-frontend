  ...
  return (
    <>
      <aside className="bg-[#232323] -translate-x-80 fixed inset-0 z-50 h-screen w-72 overflow-y-auto rounded-r-lg transition-transform duration-300 xl:translate-x-0">
          ...
          <ul className="mb-2 flex flex-col">
            <li>
              <a className="" href="#">
                ...
                >
                  <span>
                    <svg className="w-[17px] h-[17px] fill-[#fff]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
          ...
          <ul className="mb-2 flex flex-col">
            ...
            <li>
              <a className="" href="#">
                ...
                >
                  <span>
                    <svg className="w-[19px] h-[17px] fill-[#fff]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                      <path d="M160 368c26.5 0 48 21.5 48 48v16l72.5-54.4c8.3-6.2 18.4-9.6 28.8-9.6H448c8.8 0 16-7.2 16-16V64c0-8.8-7.2-16-16-16H64c-8.8 0-16 7.2-16 16V352c0 8.8 7.2 16 16 16h96zm48 124l-.2 .2-5.1 3.8-17.1 12.8c-4.8 3.6-11.3 4.2-16.8 1.5s-8.8-8.2-8.8-14.3V474.7v-6.4V468v-4V416H112 64c-35.3 0-64-28.7-64-64V64C0 28.7 28.7 0 64 0H448c35.3 0 64 28.7 64 64V352c0 35.3-28.7 64-64 64H309.3L208 492z"></path>
                    </svg>
                  </span>
                  <p className="block truncate antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">
                    Hello Assistance Request
                  </p>
                </button>
              </a>
            </li>
            <li>
              <a className="" href="#">
                ...
                >
                  ...
                  <p className="block antialiased truncate font-sans text-base leading-relaxed text-inherit font-medium capitalize">
                    Learn how to make the most of ChatDB
                  </p>
                </button>
              </a>
            </li>
          ...
          <ul className="mb-2 flex flex-col">
            ...
            <li>
              <a className="" href="#">
                ...
                >
                  <p className="block truncate antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">
                    Do Mondays are for starts on monday what
                  </p>
                </button>
              </a>
            </li>
        ...
        <div className=" border-b mb-10 border-white/20">
        </div>
          ...
          <ul className="mb-2 flex flex-col">
            <li>
              <a className="" href="#">
                ...
                >
                  <span>
                    <svg className="w-[17px] h-[17px] fill-[#ffffff]" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a className="" href="#">
                ...
                >
                  <span>
                    <svg className="w-[17px] h-[17px] fill-[#ffffff]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a className="" href="#">
                ...
                >
                  <span>
                    <svg className="w-[17px] h-[17px] fill-[#ffffff]" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
