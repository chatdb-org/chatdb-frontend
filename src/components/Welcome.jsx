...
const Welcome = () => {
  return (
    <>
      ...
      <section className="justify-center items-center min-h-screen bg-[#ECF8F7]">
          <div className=" px-6 py-12 text-center  dark:bg-neutral-900 md:px-12 lg:text-left">
            <div className="mt-20 w-100 mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
              ...
              <div className="grid items-center gap-12 lg:grid-cols-2">
                <div className=" lg:mt-0">
                  ...
                  Unlock the <span className='text-[#40B6AE]'>Conversational Power of <br />AI</span> for Your E-commerce Store
                  </h2>
                  ...
                  <Link
                    className="mb-2 inline-block rounded-lg bg-[#000] px-20 pt-4 pb-4 text-sm font-medium uppercase leading-normal text-white  transition duration-150 ease-in-out hover:bg-[#2d8f89] focus:bg-primary-600  active:bg-primary-700  dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]  md:mr-2 md:mb-0"
                    to="/screen"
                  >
                    Message ChatDB
                  </Link>
